          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-5">
                ...
                <p class="col-md-8 fs-4">Laman sesawang Sistem Perkahwinan Negeri Pahang</p>
              </div>
              <div class="col-7 text-center" >
              <div class="container-fluid mt-3">
                <a href="<?= BASEURL ?>/Register/" class="btn btn-primary btn-lg m-2">Sign Up</a>
                <a href="<?= BASEURL ?>/LogIn/" class="btn btn-primary btn-lg m-2">Log In</a>
